...
namespace TiErp.Infrastructure.Persistence
{
    public class TiErpDbContext : IdentityDbContext<ApplicationUser>
    {

        public TiErpDbContext(DbContextOptions<TiErpDbContext> options) : base(options)
        {
