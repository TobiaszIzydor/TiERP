...
namespace TiWms.Infrastructure.Repositories
{
    public class ProductionLineRepository : IProductionLineRepository
    {
        ...
        public ProductionLineRepository(TiWmsDbContext dbContext)
        {
        ...
        public ProductionLine GetByIdEntity(int id)
        {
            var productionLine = _dbContext.ProductionLines.FirstOrDefault(x => x.Id == id);
